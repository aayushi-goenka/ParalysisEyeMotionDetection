...
import 'package:testing/custom_icons_icons.dart';
import 'package:testing/home.dart';

final pages = [
  const PageData(
    icon: CustomIcons.image1,
    title: "Give us your dress",
    bgColor: Color(0xFF0043D0),
    textColor: Colors.white,
  ),
  const PageData(
    icon: CustomIcons.image2,
    title: "Tell us your style",
    textColor: Colors.white,
    bgColor: Color(0xFFFDBFDD),
  ),
  const PageData(
    icon: CustomIcons.image3,
    title: "Get a customized attire",
...
class OnboardingExample extends StatelessWidget {
  ...
  const OnboardingExample({Key? key, required this.cameras}) : super(key: key);
  @override
